        ...
        <div class="small-12 medium-9 medium-push-3 columns">
            <div class="row">
                <div class="small-12 medium-7 large-7 columns" >
                    <!--WebPartZone2 should go here -->
                    <WebPartPages:WebPartZone runat="server" Title="loc:WebPartZone2" ID="WebPartZone2" FrameType="TitleBarOnly"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
                </div>
                <div class="small-12 medium-5 large-5 columns">
                    <!--WebPartZone3 should go here -->
                    <WebPartPages:WebPartZone runat="server" Title="loc:WebPartZone3" ID="WebPartZone3" FrameType="TitleBarOnly"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>                 
                </div>
            </div>
        </div>
        <!-- LEFT COLUMN PULL -->
        <div class="small-12 medium-3 medium-pull-9 columns">
				<WebPartPages:WebPartZone runat="server" Title="loc:WebPartZone1" ID="WebPartZone1" FrameType="TitleBarOnly"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>  
        </div>
    </div>
